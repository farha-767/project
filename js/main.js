...
(function ($) {
	...
	$('.post-carousel-active').slick({
		slidesToShow: 3,
		slidesToScroll: 1,
		centerMode: true, // Enable center mode to show the center slide bigger
		centerPadding: '0', // Set centerPadding to '0' to remove the spacing around the center slide
		arrows: true,
		...
		cssEase: 'cubic-bezier(0.23, 1, 0.32, 1)', // Add the cubic-bezier animation for zoom effect
	  });
	  
	  // Initialize the carousel with the first three images visible
	  $('.post-carousel-active').slick('slickGoTo', 0);
	  
	  // Start the carousel to auto-slide
	  $('.post-carousel-active').slick('slickPlay');
		...
		responsive: [
		  {
			breakpoint: 992,
			settings: {
			  slidesToShow: 3 // Change to 3 to show 3 slides at this breakpoint
			}
		  },
		  {
			breakpoint: 767,
	  ...
	  $(document).ready(function() {
		...
		// Handle the scaling effect on slick events
		$('.post-carousel-active-4').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
			// Reset scale for all slides
			$('.pp-tour').css('transform', 'scale(1)');
			// Apply scale(1.1) to the center slide
			$(slick.$slides[nextSlide]).find('.pp-tour').css('transform', 'scale(1.1)');
		  });
		});
		...
		responsive: [
		  {
			breakpoint: 769,
			settings: {
			  slidesToShow: 2 // Change to 3 to show 3 slides at this breakpoint
			}
		  },
		  {
			breakpoint: 770,
			settings: {
			  slidesToShow: 1 // Change to 3 to show 3 slides at this breakpoint
			}
		  },
		  {
			breakpoint: 576,
	...
	function heroSliderMargin() {
		...
		if (window.innerWidth <= 420) {
			// For screens 420px or less in width
